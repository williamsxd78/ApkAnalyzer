...
public interface Dimension {
    ...
    public static final class Pixels implements Dimension {
        ...
        public static final /* synthetic */ Pixels m10061boximpl(int i) {
            return new Pixels(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static int m10062constructorimpl(int i) {
            if (i > 0) {
                return i;
            }
        ...
        public static boolean m10063equalsimpl(int i, Object obj) {
            return (obj instanceof Pixels) && i == ((Pixels) obj).m10067unboximpl();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m10064equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m10065hashCodeimpl(int i) {
            return Integer.hashCode(i);
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m10066toStringimpl(int i) {
            return "Pixels(px=" + i + ')';
        }

        public boolean equals(Object other) {
            return m10063equalsimpl(this.px, other);
        }
        ...
        public int hashCode() {
            return m10065hashCodeimpl(this.px);
        }

        public String toString() {
            return m10066toStringimpl(this.px);
        }

        /* renamed from: unbox-impl, reason: not valid java name */
        public final /* synthetic */ int m10067unboximpl() {
            return this.px;
        }
    }
