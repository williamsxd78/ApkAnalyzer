    ...
    public static class Builder {
        ...
        public Builder setPersonalisation(Date date, String str, String str2) {
            try {
                ...
                outputStreamWriter.write(new SimpleDateFormat(Date_ExtensionKt.COMMON_DATE_WEB_QUERY).format(date));
                outputStreamWriter.write(LanguageFragment.SPACE);
        ...
        public Builder setPersonalisation(Date date, Locale locale, String str, String str2) {
            try {
                ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
                OutputStreamWriter outputStreamWriter = new OutputStreamWriter(byteArrayOutputStream, "UTF-8");
                outputStreamWriter.write(new SimpleDateFormat(Date_ExtensionKt.COMMON_DATE_WEB_QUERY, locale).format(date));
                outputStreamWriter.write(LanguageFragment.SPACE);
                outputStreamWriter.write(str);
                outputStreamWriter.write(LanguageFragment.SPACE);
                outputStreamWriter.write(str2);
