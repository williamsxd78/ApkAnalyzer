...
import com.vivaaerobus.app.resources.presentation.files.Bitmap_ExtensionKt;
...
public class ExifInterface {
    ...
    static {
        ExifTag[] exifTagArr = {new ExifTag(TAG_NEW_SUBFILE_TYPE, R2.attr.textAppearanceLargePopupMenu, 4), new ExifTag(TAG_SUBFILE_TYPE, 255, 4), new ExifTag(TAG_IMAGE_WIDTH, 256, 3, 4), new ExifTag(TAG_IMAGE_LENGTH, 257, 3, 4), new ExifTag(TAG_BITS_PER_SAMPLE, 258, 3), new ExifTag(TAG_COMPRESSION, R2.attr.textAppearanceSearchResultSubtitle, 3), new ExifTag(TAG_PHOTOMETRIC_INTERPRETATION, R2.attr.textColorAlertDialogListItem, 3), new ExifTag(TAG_IMAGE_DESCRIPTION, R2.attr.tickMark, 2), new ExifTag(TAG_MAKE, R2.attr.tickMarkTint, 2), new ExifTag(TAG_MODEL, R2.attr.tickMarkTintMode, 2), new ExifTag(TAG_STRIP_OFFSETS, R2.attr.tint, 3, 4), new ExifTag(TAG_ORIENTATION, R2.attr.tintMode, 3), new ExifTag(TAG_SAMPLES_PER_PIXEL, R2.attr.titleMarginBottom, 3), new ExifTag(TAG_ROWS_PER_STRIP, R2.attr.titleMarginEnd, 3, 4), new ExifTag(TAG_STRIP_BYTE_COUNTS, R2.attr.titleMarginStart, 3, 4), new ExifTag(TAG_X_RESOLUTION, R2.attr.titleTextAppearance, 5), new ExifTag(TAG_Y_RESOLUTION, R2.attr.titleTextColor, 5), new ExifTag(TAG_PLANAR_CONFIGURATION, R2.attr.titleTextStyle, 3), new ExifTag(TAG_RESOLUTION_UNIT, R2.attr.windowActionBar, 3), new ExifTag(TAG_TRANSFER_FUNCTION, 301, 3), new ExifTag(TAG_SOFTWARE, 305, 2), new ExifTag(TAG_DATETIME, 306, 2), new ExifTag(TAG_ARTIST, 315, 2), new ExifTag(TAG_WHITE_POINT, 318, 5), new ExifTag(TAG_PRIMARY_CHROMATICITIES, R2.color.abc_primary_text_material_dark, 5), new ExifTag(TAG_SUB_IFD_POINTER, R2.color.abc_tint_seek_thumb, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT, 513, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT_LENGTH, R2.drawable.abc_btn_check_material, 4), new ExifTag(TAG_Y_CB_CR_COEFFICIENTS, R2.drawable.abc_control_background_material, 5), new ExifTag(TAG_Y_CB_CR_SUB_SAMPLING, R2.drawable.abc_dialog_material_background, 3), new ExifTag(TAG_Y_CB_CR_POSITIONING, R2.drawable.abc_edit_text_material, 3), new ExifTag(TAG_REFERENCE_BLACK_WHITE, R2.drawable.abc_ic_ab_back_material, 5), new ExifTag(TAG_COPYRIGHT, 33432, 2), new ExifTag(TAG_EXIF_IFD_POINTER, 34665, 4), new ExifTag(TAG_GPS_INFO_IFD_POINTER, 34853, 4), new ExifTag(TAG_RW2_SENSOR_TOP_BORDER, 4, 4), new ExifTag(TAG_RW2_SENSOR_LEFT_BORDER, 5, 4), new ExifTag(TAG_RW2_SENSOR_BOTTOM_BORDER, 6, 4), new ExifTag(TAG_RW2_SENSOR_RIGHT_BORDER, 7, 4), new ExifTag(TAG_RW2_ISO, 23, 3), new ExifTag(TAG_RW2_JPG_FROM_RAW, 46, 7), new ExifTag(TAG_XMP, 700, 1)};
        ...
        ExifTag[] exifTagArr5 = {new ExifTag(TAG_NEW_SUBFILE_TYPE, R2.attr.textAppearanceLargePopupMenu, 4), new ExifTag(TAG_SUBFILE_TYPE, 255, 4), new ExifTag(TAG_THUMBNAIL_IMAGE_WIDTH, 256, 3, 4), new ExifTag(TAG_THUMBNAIL_IMAGE_LENGTH, 257, 3, 4), new ExifTag(TAG_BITS_PER_SAMPLE, 258, 3), new ExifTag(TAG_COMPRESSION, R2.attr.textAppearanceSearchResultSubtitle, 3), new ExifTag(TAG_PHOTOMETRIC_INTERPRETATION, R2.attr.textColorAlertDialogListItem, 3), new ExifTag(TAG_IMAGE_DESCRIPTION, R2.attr.tickMark, 2), new ExifTag(TAG_MAKE, R2.attr.tickMarkTint, 2), new ExifTag(TAG_MODEL, R2.attr.tickMarkTintMode, 2), new ExifTag(TAG_STRIP_OFFSETS, R2.attr.tint, 3, 4), new ExifTag(TAG_THUMBNAIL_ORIENTATION, R2.attr.tintMode, 3), new ExifTag(TAG_SAMPLES_PER_PIXEL, R2.attr.titleMarginBottom, 3), new ExifTag(TAG_ROWS_PER_STRIP, R2.attr.titleMarginEnd, 3, 4), new ExifTag(TAG_STRIP_BYTE_COUNTS, R2.attr.titleMarginStart, 3, 4), new ExifTag(TAG_X_RESOLUTION, R2.attr.titleTextAppearance, 5), new ExifTag(TAG_Y_RESOLUTION, R2.attr.titleTextColor, 5), new ExifTag(TAG_PLANAR_CONFIGURATION, R2.attr.titleTextStyle, 3), new ExifTag(TAG_RESOLUTION_UNIT, R2.attr.windowActionBar, 3), new ExifTag(TAG_TRANSFER_FUNCTION, 301, 3), new ExifTag(TAG_SOFTWARE, 305, 2), new ExifTag(TAG_DATETIME, 306, 2), new ExifTag(TAG_ARTIST, 315, 2), new ExifTag(TAG_WHITE_POINT, 318, 5), new ExifTag(TAG_PRIMARY_CHROMATICITIES, R2.color.abc_primary_text_material_dark, 5), new ExifTag(TAG_SUB_IFD_POINTER, R2.color.abc_tint_seek_thumb, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT, 513, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT_LENGTH, R2.drawable.abc_btn_check_material, 4), new ExifTag(TAG_Y_CB_CR_COEFFICIENTS, R2.drawable.abc_control_background_material, 5), new ExifTag(TAG_Y_CB_CR_SUB_SAMPLING, R2.drawable.abc_dialog_material_background, 3), new ExifTag(TAG_Y_CB_CR_POSITIONING, R2.drawable.abc_edit_text_material, 3), new ExifTag(TAG_REFERENCE_BLACK_WHITE, R2.drawable.abc_ic_ab_back_material, 5), new ExifTag(TAG_COPYRIGHT, 33432, 2), new ExifTag(TAG_EXIF_IFD_POINTER, 34665, 4), new ExifTag(TAG_GPS_INFO_IFD_POINTER, 34853, 4), new ExifTag(TAG_DNG_VERSION, 50706, 1), new ExifTag(TAG_DEFAULT_CROP_SIZE, 50720, 3, 4)};
        IFD_THUMBNAIL_TAGS = exifTagArr5;
        TAG_RAF_IMAGE_SIZE = new ExifTag(TAG_STRIP_OFFSETS, R2.attr.tint, 3);
        ...
        EXIF_POINTER_TAGS = new ExifTag[]{new ExifTag(TAG_SUB_IFD_POINTER, R2.color.abc_tint_seek_thumb, 4), new ExifTag(TAG_EXIF_IFD_POINTER, 34665, 4), new ExifTag(TAG_GPS_INFO_IFD_POINTER, 34853, 4), new ExifTag(TAG_INTEROPERABILITY_IFD_POINTER, 40965, 4), new ExifTag(TAG_ORF_CAMERA_SETTINGS_IFD_POINTER, 8224, 1), new ExifTag(TAG_ORF_IMAGE_PROCESSING_IFD_POINTER, 8256, 1)};
        ...
        SimpleDateFormat simpleDateFormat2 = new SimpleDateFormat(Bitmap_ExtensionKt.SERVER_DATE_FORMAT_YYYY_MM_DD_HH_MM_SSS, Locale.US);
        sFormatterSecondary = simpleDateFormat2;
        simpleDateFormat2.setTimeZone(TimeZone.getTimeZone(Date_ExtensionKt.DEFAULT_TIME_ZONE));
        int i = 0;
        while (true) {
    ...
    private void getHeifAttributes(final SeekableByteOrderedDataInputStream seekableByteOrderedDataInputStream, int i) throws IOException {
        ...
        try {
            try {
                ...
                if (AnalyticsConstants.YES_VALUE.equals(extractMetadata3)) {
                    str = mediaMetadataRetriever.extractMetadata(29);
                    str3 = mediaMetadataRetriever.extractMetadata(30);
                    str2 = mediaMetadataRetriever.extractMetadata(31);
                } else if (AnalyticsConstants.YES_VALUE.equals(extractMetadata4)) {
    ...
    */
    public byte[] getThumbnailBytes() {
        ...
        L38:
            ...
            java.io.FileDescriptor r1 = android.system.Os.dup(r1)     // Catch: java.lang.Throwable -> L7d java.lang.Exception -> L80
            int r3 = android.system.OsConstants.SEEK_SET     // Catch: java.lang.Throwable -> L76 java.lang.Exception -> L79
            r4 = 0
            android.system.Os.lseek(r1, r4, r3)     // Catch: java.lang.Throwable -> L76 java.lang.Exception -> L79
                    ...
                    switch (i) {
                        ...
                        case 5:
                            ...
                            while (i5 < split3.length) {
                                String[] split4 = split3[i5].split(DomExceptionUtils.SEPARATOR, i10);
                        ...
                        case 10:
                            ...
                            while (i12 < split6.length) {
                                String[] split7 = split6[i12].split(DomExceptionUtils.SEPARATOR, i7);
