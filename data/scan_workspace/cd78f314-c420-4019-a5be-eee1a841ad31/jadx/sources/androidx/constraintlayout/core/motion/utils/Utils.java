...
public class Utils {
    ...
    public static void log(String str) {
        ...
        System.out.println(str2 + LanguageFragment.SPACE + str);
        DebugHandle debugHandle = sOurHandle;
        if (debugHandle != null) {
            debugHandle.message(str2 + LanguageFragment.SPACE + str);
        }
    }
