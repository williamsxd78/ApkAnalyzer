...
public final class MarqueeAnimationMode {
    ...
    private static final int Immediately = m422constructorimpl(0);
    private static final int WhileFocused = m422constructorimpl(1);
    ...
    public static final /* synthetic */ MarqueeAnimationMode m421boximpl(int i) {
    ...
    public static String m426toStringimpl(int i) {
        if (m424equalsimpl0(i, Immediately)) {
            return "Immediately";
        }
        if (m424equalsimpl0(i, WhileFocused)) {
            return "WhileFocused";
        }
    ...
    public boolean equals(Object other) {
        return m423equalsimpl(this.value, other);
    }
