...
public final class FinalSnappingItem {
    ...
    private static final int ClosestItem = m746constructorimpl(0);
    private static final int NextItem = m746constructorimpl(1);
    private static final int PreviousItem = m746constructorimpl(2);
    ...
    public static final /* synthetic */ FinalSnappingItem m745boximpl(int i) {
    ...
    public static boolean m747equalsimpl(int i, Object obj) {
        return (obj instanceof FinalSnappingItem) && i == ((FinalSnappingItem) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m748equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m749hashCodeimpl(int i) {
    ...
    public boolean equals(Object other) {
        return m747equalsimpl(this.value, other);
    }
