...
public final class StampedPathEffectStyle {
    ...
    private static final int Translate = m6255constructorimpl(0);
    private static final int Rotate = m6255constructorimpl(1);
    private static final int Morph = m6255constructorimpl(2);
    ...
    public static final /* synthetic */ StampedPathEffectStyle m6254boximpl(int i) {
    ...
    public static String m6259toStringimpl(int i) {
        return m6257equalsimpl0(i, Translate) ? "Translate" : m6257equalsimpl0(i, Rotate) ? "Rotate" : m6257equalsimpl0(i, Morph) ? "Morph" : OpenTypeScript.UNKNOWN;
    }

    public boolean equals(Object other) {
        return m6256equalsimpl(this.value, other);
    }
