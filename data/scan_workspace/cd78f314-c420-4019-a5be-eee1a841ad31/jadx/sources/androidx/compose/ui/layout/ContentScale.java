...
public interface ContentScale {
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo7339computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m7343computeFillMaxDimensioniLBOSCw;
                m7343computeFillMaxDimensioniLBOSCw = ContentScaleKt.m7343computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactor.m7456constructorimpl((Float.floatToRawIntBits(m7343computeFillMaxDimensioniLBOSCw) << 32) | (Float.floatToRawIntBits(m7343computeFillMaxDimensioniLBOSCw) & BodyPartID.bodyIdMax));
            }
        };
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo7339computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m7344computeFillMinDimensioniLBOSCw;
                m7344computeFillMinDimensioniLBOSCw = ContentScaleKt.m7344computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactor.m7456constructorimpl((Float.floatToRawIntBits(m7344computeFillMinDimensioniLBOSCw) << 32) | (Float.floatToRawIntBits(m7344computeFillMinDimensioniLBOSCw) & BodyPartID.bodyIdMax));
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            public long mo7339computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                ...
                return ScaleFactor.m7456constructorimpl((Float.floatToRawIntBits(intBitsToFloat) << 32) | (Float.floatToRawIntBits(intBitsToFloat) & BodyPartID.bodyIdMax));
            }
        };
        ...
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            public long mo7339computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                ...
                if (Float.intBitsToFloat((int) (srcSize >> 32)) <= Float.intBitsToFloat((int) (dstSize >> 32)) && Float.intBitsToFloat((int) (srcSize & BodyPartID.bodyIdMax)) <= Float.intBitsToFloat((int) (dstSize & BodyPartID.bodyIdMax))) {
                    return ScaleFactor.m7456constructorimpl((Float.floatToRawIntBits(1.0f) << 32) | (Float.floatToRawIntBits(1.0f) & BodyPartID.bodyIdMax));
                }
                m7344computeFillMinDimensioniLBOSCw = ContentScaleKt.m7344computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactor.m7456constructorimpl((Float.floatToRawIntBits(m7344computeFillMinDimensioniLBOSCw) << 32) | (Float.floatToRawIntBits(m7344computeFillMinDimensioniLBOSCw) & BodyPartID.bodyIdMax));
            }
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            public long mo7339computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                ...
                return ScaleFactor.m7456constructorimpl((Float.floatToRawIntBits(intBitsToFloat) << 32) | (Float.floatToRawIntBits(intBitsToFloat2) & BodyPartID.bodyIdMax));
            }
        };
    ...
    long mo7339computeScaleFactorH7hwNQA(long srcSize, long dstSize);
}
