...
public final class NavigationItemIconPosition {
    ...
    private static final int Top = m3242constructorimpl(0);
    private static final int Start = m3242constructorimpl(1);
    ...
    public static final /* synthetic */ NavigationItemIconPosition m3241boximpl(int i) {
        return new NavigationItemIconPosition(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m3242constructorimpl(int i) {
        return i;
    }
    ...
    public static String m3246toStringimpl(int i) {
        return m3244equalsimpl0(i, Top) ? "Top" : m3244equalsimpl0(i, Start) ? "Start" : OpenTypeScript.UNKNOWN;
    }

    public boolean equals(Object other) {
        return m3243equalsimpl(this.value, other);
    }
