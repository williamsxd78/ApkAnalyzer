...
public final class ShortNavigationBarArrangement {
    ...
    private static final int EqualWeight = m3478constructorimpl(0);
    private static final int Centered = m3478constructorimpl(1);
    ...
    public static final /* synthetic */ ShortNavigationBarArrangement m3477boximpl(int i) {
        return new ShortNavigationBarArrangement(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m3478constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3479equalsimpl(int i, Object obj) {
        return (obj instanceof ShortNavigationBarArrangement) && i == ((ShortNavigationBarArrangement) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3480equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3481hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3482toStringimpl(int i) {
        return m3480equalsimpl0(i, EqualWeight) ? "EqualWeight" : m3480equalsimpl0(i, Centered) ? "Centered" : OpenTypeScript.UNKNOWN;
    }

    public boolean equals(Object other) {
        return m3479equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m3481hashCodeimpl(this.value);
    }

    public String toString() {
        return m3482toStringimpl(this.value);
    }
