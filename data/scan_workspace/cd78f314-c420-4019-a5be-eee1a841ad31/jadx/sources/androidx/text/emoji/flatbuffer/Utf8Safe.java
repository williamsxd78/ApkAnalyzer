...
public final class Utf8Safe extends Utf8 {
    ...
    */
    private static int encodeUtf8Array(java.lang.CharSequence r7, byte[] r8, int r9, int r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.text.emoji.flatbuffer.Utf8Safe.encodeUtf8Array(java.lang.CharSequence, byte[], int, int):int");
    }
