...
public interface SQLiteStatement extends AutoCloseable {
    ...
    void mo9707bindBlob(int index, byte[] value);

    default void bindBoolean(int index, boolean value) {
        mo9709bindLong(index, value ? 1L : 0L);
    }

    /* renamed from: bindDouble */
    void mo9708bindDouble(int index, double value);

    default void bindFloat(int index, float value) {
        mo9708bindDouble(index, value);
    }

    default void bindInt(int index, int value) {
        mo9709bindLong(index, value);
    }

    /* renamed from: bindLong */
    void mo9709bindLong(int index, long value);

    /* renamed from: bindNull */
    void mo9710bindNull(int index);

    /* renamed from: bindText */
    void mo9711bindText(int index, String value);

    /* renamed from: clearBindings */
    void mo9712clearBindings();
