...
public final class Phonenumber {
    ...
    public static class PhoneNumber implements Serializable {
        ...
        public int hashCode() {
            ...
            int i = R2.styleable.AlertDialog_showTitle;
            int numberOfLeadingZeros = (((((((((countryCode + (isItalianLeadingZero ? 1231 : 1237)) * 53) + getNumberOfLeadingZeros()) * 53) + getRawInput().hashCode()) * 53) + getCountryCodeSource().hashCode()) * 53) + getPreferredDomesticCarrierCode().hashCode()) * 53;
