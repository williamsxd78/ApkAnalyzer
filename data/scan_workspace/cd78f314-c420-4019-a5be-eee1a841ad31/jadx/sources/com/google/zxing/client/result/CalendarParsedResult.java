...
public final class CalendarParsedResult extends ParsedResult {
    ...
    private static final long[] RFC2445_DURATION_FIELD_UNITS = {604800000, 86400000, DurationKt.MILLIS_IN_HOUR, 60000, 1000};
    ...
    private static long parseDate(String str) throws ParseException {
        ...
        if (str.length() == 8) {
            SimpleDateFormat simpleDateFormat = new SimpleDateFormat(Date_ExtensionKt.COMMON_DATE_WEB_QUERY, Locale.ENGLISH);
