...
public final class ColorResourcesTableCreator {
    ...
    public static class PackageChunk {
        ...
        int getChunkSize() {
            return this.typeStrings.getChunkSize() + R2.attr.tooltipFrameBackground + this.keyStrings.getChunkSize() + this.typeSpecChunk.getChunkSizeWithTypeChunk();
        }
        ...
        void writeTo(ByteArrayOutputStream byteArrayOutputStream) throws IOException {
            ...
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(R2.attr.tooltipFrameBackground));
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(0));
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(this.typeStrings.getChunkSize() + R2.attr.tooltipFrameBackground));
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(0));
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(0));
