...
public final class EmptyBackgroundTransition extends Drawable {
    ...
    public EmptyBackgroundTransition(int i, int i2) {
        this.startColor = i;
        this.endColor = i2;
    }
    ...
    public void draw(Canvas canvas) {
        ...
        float f = width;
        canvas.drawRect(f * (1 - this.progress), 0.0f, f, height, this.paint);
    }
